...
class MainMenu:
    def __init__(self, screen, switch_scene, cursor, music):
        ...
        self.buttons = []
        start_button = Button(
            rect = (screen_width - self.button_size[0] - 180, screen_height / 2 - 50, self.button_size[0], self.button_size[1]),
            text = "",
            color = button_color,
        ...
        settings_button = Button(
            rect = (screen_width - self.button_size[0] - 180, screen_height / 2 - 50 + self.gap, self.button_size[0] + 40, self.button_size[1] + 5),
            text = "",
            color = button_color,
            hover_color = button_hover_color,
            text_color = text_color,
            font = self.font,
            callback = lambda: self.switch_scene("settings_menu"),
            sprite_path = "assets/sprites/ui/settings_button.png",
            sprite_hover_path = "assets/sprites/ui/settings_button.png",
            sprite_pressed_path = "assets/sprites/ui/settings_button.png",
        )

        exit_button = Button(
            rect = (screen_width - self.button_size[0] - 180, screen_height / 2 - 50 + 2 * self.gap, self.button_size[0] - 15, self.button_size[1]),
            text = "",
            color = button_color,
            hover_color = button_hover_color,
            text_color = text_color,
